  ...
  return (
    <main className="container mx-auto px-4 py-12">
      <div className="prose dark:prose-invert mx-auto max-w-4xl">
        <h1>Privacy Policy for Unit Convertor</h1>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            this Agreement) refers to Unit Convertor .
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Unit Convertor , accessible from
            http://unitconvertor.co/
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <strong>To provide You with news, special offers</strong> and
        ...
        <ul>
          <li>
            ...
            <a
              href="http://www.unitconvertor.co/contact"
              target="_blank"
              rel="noopener noreferrer"
            >
              http://www.unitconvertor.co/contact
            </a>
          </li>
        </ul>
      </div>
